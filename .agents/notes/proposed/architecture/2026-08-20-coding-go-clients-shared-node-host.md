...
- Release artifacts materialize a checksum-verified Host runtime under `$DSH_HOME/runtime/<version>` and do not require a globally installed Node executable.
