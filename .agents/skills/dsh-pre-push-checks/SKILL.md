...
- **Documentation, catalogs, or doc-linked comments:** run the owning generator (`pnpm run gen-<name>`) and inspect the regenerated diff; run full lint when the documentation workflow requires it.
