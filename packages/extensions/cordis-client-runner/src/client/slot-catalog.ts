...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: '对话主区域；无当前会话时仍保持同一个 `session-maybe` entry。',
    doc: '对话主区域；无当前会话时仍保持同一个 `session-maybe` entry。',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: '欢迎页右上角的全局面板操作；由侧边栏和工作台插件各自注册。',
    doc: '欢迎页右上角的全局面板操作；由侧边栏和工作台插件各自注册。',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  },
  {
    ...
    occupants: [
      ...
      'session-log-export SessionLogDownloadContribution id \'session-log-download\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: '既有会话详情栏；工作台打开时保持挂载但不参与布局。',
    doc: '既有会话详情栏；工作台打开时保持挂载但不参与布局。',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: '全框架浮层；容器透传指针事件，由各 entry 自行恢复。',
    doc: '全框架浮层；容器透传指针事件，由各 entry 自行恢复。',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: '整个左侧导航栏；占用者负责展开态和紧凑 rail。',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: '宽侧边栏中渲染的品牌名称。由本包的 `sidebar` 条目声明；壳层提供通用文本兜底。',
    doc: '宽侧边栏中渲染的品牌名称。由本包的 `sidebar` 条目声明；壳层提供通用文本兜底。',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-open-in-app WorkspaceWorkbench',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-open-in-app RetainedTerminalPanel',
    ],
    replaceRisk: 'shadows-shipped-ui',
