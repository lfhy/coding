...
包 README 覆盖用途、API、扩展点和[模型体验](../docs/cookbook/adding-a-package.md#4-write-the-package-readme)；与模型无关的包用一句话说明这一点。它们还要包含 `## Known Limitations and Deferred Work`，没有已知限制时同样用一句话说明。
