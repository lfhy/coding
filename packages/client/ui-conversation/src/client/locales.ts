...
export const zh = {
  ...
  'hero.greeting.evening': '晚上好呀，今天辛苦啦',
  'hero.chooseWorkspace': '选择工作区',
  'hero.noProject': '不在项目中工作',
  ...
  'chat.loadOlder': '加载更早',
  'chat.toBottom': '回到底部',
  'chat.anchors.label': '会话轨迹导航',
  'chat.anchors.position': '第 {current}/{total} 条：{title}',
  'chat.anchors.compact': '跳转到消息',
  'chat.anchors.close': '关闭会话导航',
  'chat.anchors.image': '图片消息',
  'chat.anchors.empty': '空消息',
...
export const en = {
  ...
  'hero.greeting.noon': 'Good midday, take a short break',
  'hero.greeting.afternoon': 'Good afternoon, I will take it from here',
  'hero.greeting.evening': 'Good evening, you did a lot today',
  'hero.chooseWorkspace': 'Choose workspace',
  'hero.noProject': 'Working without a project',
  ...
  'chat.anchors.label': 'Conversation navigation',
  'chat.anchors.position': 'Message {current} of {total}: {title}',
  'chat.anchors.compact': 'Jump to message',
  'chat.anchors.close': 'Close conversation navigation',
  'chat.anchors.image': 'Image message',
  'chat.anchors.empty': 'Empty message',
