...
export const zh = {
  ...
  'workbench.bottom.open': '打开底栏',
  'workbench.bottom.close': '关闭底栏',
  'workbench.bottom.opening': '正在打开底栏…',
  'workbench.bottom.failed': '打开底栏失败：{message}',
  'workbench.files.show': '显示文件侧栏',
  'workbench.files.hide': '隐藏文件侧栏',
  'workbench.files.opening': '正在打开文件侧栏…',
  'workbench.files.failed': '打开文件侧栏失败：{message}',
...
export const en: Record<OpenInAppKey, string> = {
  ...
  'workbench.bottom.open': 'Open bottom panel',
  'workbench.bottom.close': 'Close bottom panel',
  'workbench.bottom.opening': 'Opening bottom panel…',
  'workbench.bottom.failed': 'Could not open bottom panel: {message}',
  'workbench.files.show': 'Show files sidebar',
  'workbench.files.hide': 'Hide files sidebar',
  'workbench.files.opening': 'Opening files sidebar…',
  'workbench.files.failed': 'Could not open files sidebar: {message}',
