...
async function bench() {
  ...
  ctx.provide('workspaces', {
    create, startSession, startSessionWithoutWorkspace, rename, insertSessionBefore,
  } as never)
  ...
  return {
    ctx, slots: ctx.get('slots') as SlotRegistry, locale, create, startSession, startSessionWithoutWorkspace, rename,
...
describe('ui-workspace apply', () => {
  ...
  it('registers browser and pickers for declarations arriving before or after apply', async () => {
    ...
    expect(before.locale.bind('workspace')('section.workspaces')).toBe('工作区')
