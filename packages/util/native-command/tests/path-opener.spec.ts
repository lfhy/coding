...
import { canOpenNativePath, openNativePath, openNativeTextFile, type PathOpenerRunner } from '@deepseek-ai/dsh-native-command'
...
describe('canOpenNativePath', () => {
  it('samples the running platform when no override is supplied', () => {
    expect(typeof canOpenNativePath()).toBe('boolean')
  })
