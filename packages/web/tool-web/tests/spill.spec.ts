 ...
 * `ctx.tools.execute()`. Proves the design record's default local-backend path — a large
...
beforeEach(async () => {
  ...
  // policy cap is what triggers the spill (the design record's separation of concerns).
