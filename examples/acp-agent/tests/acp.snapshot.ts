 ...
 * See the package README (packages/test-support/acp-snapshot) and the snapshot design record,
 */
...
const SCENARIOS: Scenario[] = [
  ...
  // Unit tests cover those points; the hook-snapshot-matrix design record owns the rationale.
