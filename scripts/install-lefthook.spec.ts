...
describe('worktree-local Lefthook installer', { timeout: 30_000 }, () => {
  ...
  it('isolates main and linked worktrees without changing legacy common hooks', async () => {
    ...
    // Windows Git follows the fixture's reparse points into their real targets
    // while removing a worktree; unlink them first so the removal cannot reach
    // files outside the fixture tree.
