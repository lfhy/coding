...
Source: [`packages/shell/bash-local/src/index.ts:44`](../packages/shell/bash-local/src/index.ts)
...
Source: [`packages/code-runtime/code-runtime-worker-thread/src/index.ts:33`](../packages/code-runtime/code-runtime-worker-thread/src/index.ts)
...
Source: [`packages/fs/fs-local/src/index.ts:52`](../packages/fs/fs-local/src/index.ts)
...
Source: [`packages/fs/fs-sandbox/src/index.ts:56`](../packages/fs/fs-sandbox/src/index.ts)
...
Requires: `webServer` · `connection` · `subprocess` · `fs` · `sessions` · `agents`
...
Source: [`packages/host/open-in-app/src/index.ts:71`](../packages/host/open-in-app/src/index.ts)
...
Source: [`packages/shell/pwsh-local/src/index.ts:57`](../packages/shell/pwsh-local/src/index.ts)
...
Source: [`packages/session/session-telemetry-otel/src/index.ts:89`](../packages/session/session-telemetry-otel/src/index.ts)
...
Source: [`packages/shell/tool-pwsh/src/index.ts:50`](../packages/shell/tool-pwsh/src/index.ts)
...
- `@deepseek-ai/dsh-client-ui-icons` ([`packages/client/ui-icons/src/index.ts`](../packages/client/ui-icons/src/index.ts))
